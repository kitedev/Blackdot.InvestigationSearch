...
{
    /// <summary>
    /// Provide query selector methods for the Bing search engine
    /// </summary>
    public class BingSearchEngineSelector : ISelector
    {
        ...
        public BingSearchEngineSelector(string urlSelector, string titleSelector, string captionSelector)
        {
